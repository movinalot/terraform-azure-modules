locals {
  virtual_machines = {
    "vm-fgt-a" = {
      ...
      #"availability_set_id" = module.module_azure_availability_set["as_1"].subnet.id
      "availability_set_id" = null

      "delete_os_disk_on_termination"    = true
      "delete_data_disks_on_termination" = true

      "network_interface_ids" = [for nic in ["nic-fortigate_a_1", "nic-fortigate_a_2"] : module.module_azure_network_interface[nic].network_interface.id]

      "primary_network_interface_id" = module.module_azure_network_interface["nic-fortigate_a_1"].network_interface.id
    ...
    "vm-fgt-b" = {
      ...
      "network_interface_ids" = [for nic in ["nic-fortigate_b_1", "nic-fortigate_b_2"] : module.module_azure_network_interface[nic].network_interface.id]

      "primary_network_interface_id" = module.module_azure_network_interface["nic-fortigate_b_1"].network_interface.id
