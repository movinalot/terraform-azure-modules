      ...
      ip_configurations = [
        {
          ...
          private_ip_address            = cidrhost(module.module_azure_subnet["external"].subnet.address_prefix, 4)
          public_ip_address_id          = module.module_azure_public_ip["pip-fgt"].public_ip.id
        }
      ]
    },
    "nic-fortigate_2" = {
